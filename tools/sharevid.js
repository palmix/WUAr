...
document.getElementById('btnvideoshowid').innerHTML = '<table border="0"><tr><td>' + btnvideoshow +'</td></tr><div class="owl-carousel owl-theme"><tr><td>'+btnvideodownload+'</td></tr></div></table>';
