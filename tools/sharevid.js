...
document.getElementById('btnvideoshowid').innerHTML =  '<div class="owl-carousel owl-theme"><table><tr><td>' + btnvideoshow + '</td></tr><tr><td>' + btnvideodownload + '</td></tr></table></div>';
