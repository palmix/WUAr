...
btncardinf.onclick = function() {
        ...
        modalcardinf.style.display = "none"
...
if (cardinfonume0 > 20) {
        var cardinfonume0noimgurl = $("#cardinfo0").find("img").attr("src"),
                cardinfonume0noimgurl = cardinfonume0noimgurl.replace("/s200/", "/w136-h136-p/"),
                cardinfonume0noimgurl = cardinfonume0noimgurl.replace("/s320/", "/w136-h136-p/"),
   ...
   if(document.getElementById("answercardinfoimgsize")){
$("#answercardinfoimgsize a").replaceWith(function() { 
